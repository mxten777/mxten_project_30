                ...
                >
                  ...
                  <div className="flex items-start justify-between mb-8 relative z-10">
                    <div className="flex items-center space-x-6">
                      ...
                      <div>
                        <h3 className="text-3xl font-bold text-gray-900 mb-3 font-heading">
                          {service.title}
                        </h3>
                        {service.price && (
                          <motion.div 
                          ...
                          >
                            ...
                            <span className="text-lg text-primary-600 font-bold font-body">
                  ...
                  >
                    <PremiumButton
                      ...
                      className="w-full group/btn premium-shadow-glow hover:premium-shadow-glow-intense"
                    >
                      <div className="flex items-center justify-center space-x-3">
                        <Zap className="w-5 h-5" />
                        <span className="font-bold">견적 문의</span>
