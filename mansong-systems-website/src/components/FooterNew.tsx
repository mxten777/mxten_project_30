...
import { COMPANY_INFO, CONTACT_INFO, BUSINESS_STATS, FAQ_DATA } from '../data';
          ...
          <div className="container-custom py-16">
            <div className="text-center mb-12">
              <h3 className="text-3xl font-bold mb-4">
                <span className="text-gradient">숫자로 보는 만송시스템</span>
              </h3>
              <p className="text-gray-400 max-w-2xl mx-auto">
                30년+ 경험과 검증된 실력으로 고객의 성공을 함께 만들어가고 있습니다
              </p>
            </div>
