...
import { Building2, Cog, Users2, Award } from 'lucide-react';
      ...
      <div className="container-custom">
        ...
        >
          <div className="inline-flex items-center space-x-2 bg-primary-50 rounded-full px-4 py-2 mb-6">
            ...
            <span className="text-sm font-medium text-primary-600">ABOUT US</span>
          </div>
          
          <h2 className="text-4xl lg:text-5xl font-bold text-gray-900 mb-6">
            <span className="block">30년 경험으로 만드는</span>
            <span className="text-gradient">신뢰받는 파트너</span>
          </h2>
          
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            {COMPANY_INFO.description}을 통해<br />
            고객의 성공을 함께 만들어갑니다
          </p>
        </motion.div>
